...
public class NodeMemoryConfig
{
    ...
    private DataSize maxQueryMemoryPerNode = DataSize.ofBytes((long) (AVAILABLE_HEAP_MEMORY * 0.1));

    // This is a per-query limit for the user plus system allocations.
    private DataSize maxQueryTotalMemoryPerNode = DataSize.ofBytes((long) (AVAILABLE_HEAP_MEMORY * 0.3));
    private DataSize heapHeadroom = DataSize.ofBytes((long) (AVAILABLE_HEAP_MEMORY * 0.3));
