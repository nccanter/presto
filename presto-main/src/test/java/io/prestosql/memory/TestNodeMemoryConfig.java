...
public class TestNodeMemoryConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(NodeMemoryConfig.class)
                .setMaxQueryMemoryPerNode(DataSize.ofBytes((long) (AVAILABLE_HEAP_MEMORY * 0.1)))
                .setMaxQueryTotalMemoryPerNode(DataSize.ofBytes((long) (AVAILABLE_HEAP_MEMORY * 0.3)))
                .setHeapHeadroom(DataSize.ofBytes((long) (AVAILABLE_HEAP_MEMORY * 0.3)))
